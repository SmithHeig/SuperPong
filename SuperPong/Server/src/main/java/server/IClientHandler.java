...
public interface IClientHandler {
	 ...
	 *
	 * @param is
	 * 		input stream to read commands sent by the client
	 * @param os
	 * 		output stream to send responses back to the client
	 *
	 * @throws java.io.IOException
	 */
	void handleClientConnection(InputStream is, OutputStream os) throws IOException;
