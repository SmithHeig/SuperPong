...
public class SuperPongProtocole {
    public final static String CMD_CONNECT ="CONNECT";
    public final static String CMD_ADD_FRIEND = "ADD_FRIEND"; // TODO: fonctionnalité à implémenter
    public final static String CMD_SHOW_FRIEND = "SHOW_FRIENDS"; // TODO: fonctionnalité à implémenter
    public final static String CMD_SHOW_STATS = "SHOW_STATS";
